...
Source0  : https://sourceforge.net/projects/fldigi/files/flmsg/flmsg-4.0.16.tar.gz
...
%prep
%setup -q -n flmsg-4.0.16
cd %{_builddir}/flmsg-4.0.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593123179
...
cp %{_builddir}/flmsg-4.0.16/COPYING %{buildroot}/usr/share/package-licenses/flmsg/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
