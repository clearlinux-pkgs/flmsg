...
Source0  : https://sourceforge.net/projects/fldigi/files/flmsg/flmsg-4.0.20.tar.gz
...
%prep
%setup -q -n flmsg-4.0.20
cd %{_builddir}/flmsg-4.0.20
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656340703
...
cp %{_builddir}/flmsg-4.0.20/COPYING %{buildroot}/usr/share/package-licenses/flmsg/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
