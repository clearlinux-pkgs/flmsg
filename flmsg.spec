...
Version  : 4.0.4
Release  : 3
URL      : https://sourceforge.net/projects/fldigi/files/flmsg/flmsg-4.0.4.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flmsg/flmsg-4.0.4.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1515858152
