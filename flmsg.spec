...
Source0  : https://sourceforge.net/projects/fldigi/files/flmsg/flmsg-4.0.15.tar.gz
...
%prep
%setup -q -n flmsg-4.0.15
cd %{_builddir}/flmsg-4.0.15
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591025278
...
cp %{_builddir}/flmsg-4.0.15/COPYING %{buildroot}/usr/share/package-licenses/flmsg/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
